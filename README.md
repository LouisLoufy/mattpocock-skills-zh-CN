...
- 2026-05-22：同步上游 `mattpocock/skills@b8be62f`，本地提交待补。新增 architecture HTML report 指南，更新 handoff 临时文件与 redaction 规则，并收紧 `CONTEXT.md` template。
...
- [x] README 同步记录指向最新上游 `b8be62f`，本地同步提交将在提交后补齐。
